...
The feasible set is the quadrilateral formed by the overlap of all three constraint regions. The level sets of the objective function are straight lines of the form $0.04x + 0.03y = c$. We can use a graphical calculator to find the largest value of $c$ for which these level sets intersect the feasible region, which turns out to be $c = 3.3\%$ which gives us a net yield of $3.3\% \times \$100,000 = \$3,300$.

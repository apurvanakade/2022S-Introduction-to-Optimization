...
\begin{align}
  ...
  \end{array}
\end{align}
So, $\delta_- = -5/2$ and $\delta_+ = 2$ and the range of optimality of $c_1$ is $(4 - 5/2, 4 + 2) = (1.5, 6)$.
...
\begin{align}
  ...
  \end{array}
\end{align}
So, $\delta_- = -1$ and $\delta_+ = 5$ and the range of optimality of $c_1$ is $(3 - 1, 3 + 5) = (2, 8)$.
